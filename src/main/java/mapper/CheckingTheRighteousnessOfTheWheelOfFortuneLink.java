...
public class CheckingTheRighteousnessOfTheWheelOfFortuneLink extends JUnitStories {
	 
		public CheckingTheRighteousnessOfTheWheelOfFortuneLink() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CheckingTheRighteousnessOfTheWheelOfFortuneLink.story");
		}
