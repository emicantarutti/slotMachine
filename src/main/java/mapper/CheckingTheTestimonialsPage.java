...
public class CheckingTheTestimonialsPage extends JUnitStories {
	 
		public CheckingTheTestimonialsPage() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CheckingTheTestimonialsPage.story");
		}
