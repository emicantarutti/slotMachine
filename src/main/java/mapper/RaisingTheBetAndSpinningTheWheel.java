...
public class RaisingTheBetAndSpinningTheWheel extends JUnitStories {
	 
		public RaisingTheBetAndSpinningTheWheel() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/RaisingTheBetAndSpinningTheWheel.story");
		}
