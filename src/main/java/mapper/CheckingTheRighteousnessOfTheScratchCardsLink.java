...
public class CheckingTheRighteousnessOfTheScratchCardsLink extends JUnitStories {
	 
		public CheckingTheRighteousnessOfTheScratchCardsLink() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CheckingTheRighteousnessOfTheScratchCardsLink.story");
		}
