...
public class RaisingTheBetTenTimesAndVerifyingTheCorrectness extends JUnitStories {
	 
		public RaisingTheBetTenTimesAndVerifyingTheCorrectness() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/RaisingTheBetTenTimesAndVerifyingTheCorrectness.story");
		}
