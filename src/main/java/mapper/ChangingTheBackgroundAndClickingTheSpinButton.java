...
public class ChangingTheBackgroundAndClickingTheSpinButton extends JUnitStories {
	 
		public ChangingTheBackgroundAndClickingTheSpinButton() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/ChangingTheBackgroundAndClickingTheSpinButton.story");
		}
