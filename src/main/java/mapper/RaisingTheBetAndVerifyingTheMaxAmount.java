...
public class RaisingTheBetAndVerifyingTheMaxAmount extends JUnitStories {
	 
		public RaisingTheBetAndVerifyingTheMaxAmount() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/RaisingTheBetAndVerifyingTheMaxAmount.story");
		}
