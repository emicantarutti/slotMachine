...
public class LoweringDownTheBetAndVerifyingTheMinimumAmount extends JUnitStories {
	 
		public LoweringDownTheBetAndVerifyingTheMinimumAmount() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/LoweringDownTheBetAndVerifyingTheMinimumAmount.story");
		}
