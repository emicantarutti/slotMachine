...
And I raise the bet
And I raise the bet
Then I verify that the value of 'Bet' is '10'
And I verify that the value of the highest prize is '2000'
And I verify that the value of the second prize is '500'
